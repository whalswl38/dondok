...
public class TripCommentDto {
	...
	public String toString() {
		return "TripCommentDto [rv_no=" + rv_no + ", rv_crno=" + rv_crno + ", rv_pno=" + rv_pno + ", level=" + level
				+ ", isleaf=" + isleaf + ", rv_id=" + rv_id + ", rv_content=" + rv_content + ", rv_delflag="
				+ rv_delflag + ", rv_date=" + rv_date + "]";
	}
	public int getRv_no() {
		return rv_no;
	}
	...
	public TripCommentDto(int rv_no, int rv_crno, int rv_pno, int level, int isleaf, String rv_id, String rv_content,
			String rv_delflag, Date rv_date) {
		super();
		this.rv_no = rv_no;
		this.rv_crno = rv_crno;
		this.rv_pno = rv_pno;
